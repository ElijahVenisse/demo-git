...
class BSITController extends Controller
{
    ...
    {
        $users = User::where('department', 'BSIT')->orderBy('created_at', 'desc')->get();
        ...
        return view('admin.bsit', compact('users', 'departments', 'yearLevels'));
    }

    public function create()
    {
        return view('admin.create_bsit');
    }
    ...
    public function store(Request $request)
    {
        ...
        // Set department to BSIT
        $validatedData['department'] = 'BSIT';
        $validatedData['password'] = Hash::make($validatedData['password']);

        User::create($validatedData);

        return redirect()->route('admin.bsit')->with('success', 'BSIT student added successfully');
    }
    ...
    public function generateReport()
    {
        ...
        $html = view('admin.bsit_report', compact('users'))->render();

        $mpdf = new Mpdf();
        $mpdf->WriteHTML($html);
        $mpdf->Output('bsit_students_report.pdf', 'D');
    }
